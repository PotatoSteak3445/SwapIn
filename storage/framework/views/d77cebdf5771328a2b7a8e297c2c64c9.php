    ...
    <div class="products-grid">
        ...
        <div class="product-card">
            ...
            <?php if($product->old_price): ?>
                ...
                ?>
                <span class="badge"><?php echo e($discount); ?>% OFF</span>
            <?php endif; ?>

            <div class="product-img-wrap">
                <img src="https://placehold.co/160x160/f5f5f5/333?text=<?php echo e($product->name); ?>" alt="<?php echo e($product->name); ?>">
            </div>

            <div class="product-info">
                <p class="product-name"><?php echo e($product->name); ?></p>
                <div class="product-prices">
                    <span class="price-current">Rp. <?php echo e(number_format($product->price, 0, ',', '.')); ?></span>
                    <?php if($product->old_price): ?>
                        <span class="price-old">Rp. <?php echo e(number_format($product->old_price, 0, ',', '.')); ?></span>
                    <?php endif; ?>
                </div>
                <p class="price-save">Hemat – Rp. <?php echo e(number_format($product->old_price - $product->price, 0, ',', '.')); ?></p>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/potato/Documents/SEMESTER 6 /trade-in/resources/views/welcome.blade.php ENDPATH**/ ?>
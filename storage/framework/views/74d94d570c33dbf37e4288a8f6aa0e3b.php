...
<header style="background:#fff; border-bottom:1px solid var(--border-color); position: sticky; top:0; z-index:100;">
    <div style="max-width:1400px; margin:0 auto; padding:12px 40px; display:flex; align-items:center; justify-content:space-between;">
        <div style="display:flex; align-items:center; gap:40px;">
            <a href="<?php echo e(route('home')); ?>" style="font-size:24px; font-weight:800; color:var(--primary-green); text-decoration:none;">SwapIn.</a>
...
<div style="max-width:1400px; margin:0 auto; padding:32px 40px; display:flex; gap:32px;">
    ...
    <main style="flex:1; min-width:0;">
        ...
        <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:32px;">
            ...
            <a href="<?php echo e(route('toko.tambah-produk')); ?>" class="btn-add" style="text-decoration:none;">
        ...
        <div style="display:grid; grid-template-columns:repeat(4,1fr); gap:20px; margin-bottom:32px;">
            ...
            <div class="glass-card" style="padding:24px;">
                <p style="font-size:13px; font-weight:600; color:var(--text-muted); margin:0 0 12px;"><?php echo e($s['label']); ?></p>
                <h3 style="font-size:20px; font-weight:800; margin:0 0 8px; color:<?php echo e($s['color']); ?>"><?php echo e($s['value']); ?></h3>
                <span style="font-size:12px; color:#10b981; font-weight:600;"><?php echo e($s['trend']); ?></span>
            </div>
                        ...
                        <tr style="border-bottom:1px solid var(--border-color); transition: background 0.2s;" onmouseover="this.style.background='#fcfdfd'" onmouseout="this.style.background='transparent'">
                            <td style="padding:16px 24px;">
                                <div style="display:flex; align-items:center; gap:12px;">
                                    ...
                                    <div>
                                        <p style="font-weight:700; margin:0; font-size:14px;"><?php echo e($p['name']); ?></p>
                                        <p style="color:var(--text-muted); margin:0; font-size:12px;"><?php echo e($p['cat']); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td style="padding:16px 24px; font-weight:700; font-size:14px;"><?php echo e($p['price']); ?></td>
                            <td style="padding:16px 24px; font-size:14px;"><?php echo e($p['stock']); ?> unit</td>
                            <td style="padding:16px 24px;">
                                <span class="status-pill" style="background:<?php echo e($p['status']=='Aktif' ? '#dcfce7' : '#fee2e2'); ?>; color:<?php echo e($p['status']=='Aktif' ? '#15803d' : '#b91c1c'); ?>;">
                                    <?php echo e($p['status']); ?>
...
<?php /**PATH /home/potato/Documents/SEMESTER 6 /trade-in/resources/views/toko/dashboard.blade.php ENDPATH**/ ?>
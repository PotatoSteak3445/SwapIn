...
<div class="auth-page">
    ...
    <div class="auth-left">
        <a href="<?php echo e(route('home')); ?>" class="auth-logo">Trade-in</a>
        <img src="<?php echo e(asset('images/photo.jpg')); ?>" alt="Trade-in illustration" class="auth-illustration">
...
<?php /**PATH /home/potato/Documents/SEMESTER 6 /trade-in/resources/views/auth/register.blade.php ENDPATH**/ ?>
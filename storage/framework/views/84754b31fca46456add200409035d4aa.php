    ...
    <a href="/" class="logo">SwapIn</a>
        ...
        <div class="nav-icons">
            <?php if(auth()->guard()->check()): ?>
                ...
                <a href="<?php echo e(route('toko.dashboard')); ?>" class="nav-icon-link">
                    <span>Toko Saya</span>
                </a>
...
<div id="login-modal" class="modal-overlay" onclick="if(event.target===this)this.classList.remove('active')">
    <div class="modal-box">
        <div class="modal-header">
            <h2>Masuk</h2>
            <a href="<?php echo e(route('register')); ?>" class="modal-register-link">Register</a>
        </div>
...
<?php /**PATH /home/potato/Documents/SEMESTER 6 /trade-in/resources/views/partials/navbar.blade.php ENDPATH**/ ?>